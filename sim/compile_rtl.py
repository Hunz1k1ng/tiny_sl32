...
def main():
    ...
    iverilog_cmd.append(rtl_dir + r'/rtl/core/booth_17p.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/core/p_gen.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/core/walloc_17.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/core/multi_32.v')
